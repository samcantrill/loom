...
class LocalDaemonExecution:
    ...
    def _reconcile_slurm_run(
        ...
        for retained in records:
            ...
            if record.state == "logical_released":
            ...
            if record.state in {"bound", "submitting", "unknown"}:
                ...
                if submission is None or submission.state is ReadyStageState.INTENT:
                    ...
                    submission = self.slurm_submissions.submit(
                        request, profile, script_path
                    )
    ...
    def _dispatch_slurm_ready(
        ...
        *,
        ...
        try:
            ...
            submission = self.slurm_submissions.submit(request, profile, script_path)
    ...
    def slurm_register(
        ...
        *,
        ...
        return self.slurm_assignments.register_bootstrap(
            operation_id,
