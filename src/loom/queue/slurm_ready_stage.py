...
SLURM_STAGE_DELIVERY_SCHEMA_VERSION = 1
        ...
        *,
        ...
        with self._transaction() as conn:
            ...
            conn.execute(
                ...
                "fence, process_execution_id, report_json) VALUES (?, ?, ?, ?, ?, "
                "'reserved', ?, ?, ?, ?, ?, NULL, NULL, NULL, 0, NULL, NULL, NULL)",
                (
                    assignment.assignment_id,
        ...
        *,
        ...
        with self._transaction() as conn:
            ...
            conn.execute(
                ...
                "bootstrap_incarnation = ? WHERE assignment_id = ?",
...
def _require_schema(conn: sqlite3.Connection) -> None:
    ...
    if columns != expected or output_columns != {
        "assignment_id",
        "transfer_id",
        "descriptor_json",
        "received_bytes",
