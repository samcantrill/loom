"""Digest and fingerprint helpers."""
...
_SUPPORTED = {"sha256": 64}


def parse_digest(value: str) -> ParsedDigest:
    """Parse and normalize a digest string."""
...
def validate_digest(value: object, *, algorithms: set[str] | None = None) -> str:
    """Validate a persisted digest string and return canonical form."""
...
def hash_bytes(data: bytes, *, algorithm: str = "sha256") -> str:
    ...
    return format_digest(algorithm, hasher.hexdigest())
...
def hash_mapping(mapping: object, *, algorithm: str = "sha256") -> str:
    """Hash a mapping using stable plain-data hashing."""
...
def _normalise_algorithm(algorithm: str, *, algorithms: set[str] | None = None) -> str:
    ...
    allowed = algorithms or set(_SUPPORTED)
