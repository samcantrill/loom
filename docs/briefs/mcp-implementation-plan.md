...
functionality not yet implemented. This document explains the approved behavior
...
review status. Examples show proposed public behavior. Internal code sketches
...
Phase 4 wraps the completed native functionality. All four phases remain pending.
