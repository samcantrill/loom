...
| --- | --- | --- |
| `make validate-pr` | Passed | Rerun during PR-body refine; Ruff, Pyright, default harness, config-extra harness, and build all passed. |
| `make test-summary` | Passed | Generated `build/test-summary.md` at `2026-05-09T15:41:06+00:00`; overall 1437 passed, 0 failed, 0 errors, 11 skipped, 1035 deselected in 129.86s. |
| GitHub checks | Pending | GitHub checks start after PR creation; no GitHub result was available at PR-prep time. |

### Test Suite Summary

| Suite | Status | Passed | Failed | Errors | Skipped | Deselected | Duration |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| package | passed | 56 | 0 | 0 | 1 | 0 | 7.71s |
| unit | passed | 774 | 0 | 0 | 1 | 0 | 16.99s |
| contract | passed | 86 | 0 | 0 | 2 | 0 | 4.19s |
| integration | passed | 68 | 0 | 0 | 7 | 10 | 53.27s |
| e2e | passed | 37 | 0 | 0 | 0 | 1 | 15.53s |
| config-extra | passed | 416 | 0 | 0 | 0 | 1024 | 32.17s |
| Overall | passed | 1437 | 0 | 0 | 11 | 1035 | 129.86s |
