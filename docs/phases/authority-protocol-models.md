...
- Blocker resolution: 1/3 used on 2026-05-11
...
- Blocker-resolution summary: 1/3 used after automated PR review found that readiness parsing accepted mismatched top-level and nested compatibility facts. The fix rejects conflicting `protocol_version` and `schema_version` aliases and adds focused unit coverage.
