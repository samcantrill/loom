...
- Related implementation plans:
  ...
  - `docs/implementation-plans/implementation-plan-v9.md` (post-review
...
- Notes path: `docs/implementation-plans/roadmap-v9-planning-notes.md`
...
- Resume instruction: start a fresh/compacted pass, then reload this notes
  file, `.codex/prompts/roadmap-version-planning-notes-facilitate.md`, the v9
...
`docs/implementation-plans/implementation-plan-v9.md` was drafted and
...
| Which roadmap items should be split further after this reframing? | Roadmap scope | Use the refined eight-phase v9 split in `implementation-plan-v9.md`; the six-phase split remains only historical planning context. | answered for planning |
