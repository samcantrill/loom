...
| Handoff | User confirmed notes are ready; implementation-plan draft created at `docs/implementation-plans/implementation-plan-v6.md`. | Downstream plan quality gate must run before phase execution planning or implementation. | None. | Implementation-plan review/refinement. |
...
- Notes path: `docs/implementation-plans/roadmap-v6-planning-notes.md`
- Resume instruction: reread this planning-notes file,
  `.codex/prompts/roadmap-version-planning-notes-facilitate.md`, and the
