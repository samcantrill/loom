...
- PR review and merge: manager automated review passed with no blocking
  findings; PR target verified as `develop`; GitHub CI `checks` passed; PR
  #185 merged to `develop` as squash commit
