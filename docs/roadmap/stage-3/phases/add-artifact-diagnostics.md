...
- Phase execution plan path: `docs/roadmap/stage-3/phases/add-artifact-diagnostics.md`
...
- PR preparation: complete on 2026-05-07 by managing agent. PR body drafted at
  `docs/roadmap/stage-3/phases/add-artifact-diagnostics-pr-body.md`; PR opened as
