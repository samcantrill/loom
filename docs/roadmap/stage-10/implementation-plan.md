...
- Source planning notes: `docs/roadmap/stage-10/planning.md`
...
- Phase execution plan: `docs/roadmap/stage-10/phases/authority-registry-records.md`.
- PR body: `docs/roadmap/stage-10/phases/authority-registry-records-pr-body.md`.
...
- Phase execution plan: `docs/roadmap/stage-10/phases/authority-supervisor-lifecycle.md`.
- PR body: `docs/roadmap/stage-10/phases/authority-supervisor-lifecycle-pr-body.md`.
...
- Phase execution plan:
  `docs/roadmap/stage-10/phases/authority-resolver-adoption.md`
- PR body: `docs/roadmap/stage-10/phases/authority-resolver-adoption-pr-body.md`
...
- Phase execution plan:
  `docs/roadmap/stage-10/phases/authority-run-online-path.md`
- PR body: `docs/roadmap/stage-10/phases/authority-run-online-path-pr-body.md`
- Stack target: root phase PR targeting `develop`
...
- Phase execution plan:
  `docs/roadmap/stage-10/phases/authority-worker-continuations.md`
- PR body: `docs/roadmap/stage-10/phases/authority-worker-continuations-pr-body.md`
- Stack target: root phase PR targeting `develop`
...
- Phase execution plan: `docs/roadmap/stage-10/phases/authority-workspace-coordination.md`
- PR body: `docs/roadmap/stage-10/phases/authority-workspace-coordination-pr-body.md`
...
- Phase execution plan: `docs/roadmap/stage-10/phases/authority-resource-leases.md`.
...
- Branch: `codex/authority-offline-evidence`
- Phase execution plan: `docs/roadmap/stage-10/phases/authority-offline-evidence.md`
- PR body: `docs/roadmap/stage-10/phases/authority-offline-evidence-pr-body.md`
- PR: https://github.com/samcantrill/loom/pull/135
- Stack target: root phase PR targeting `develop`
...
- Branch: `codex/authority-offline-import`
- Phase execution plan: `docs/roadmap/stage-10/phases/authority-offline-import.md`
- PR body: `docs/roadmap/stage-10/phases/authority-offline-import-pr-body.md`
- PR: https://github.com/samcantrill/loom/pull/136
- Stack target: root phase PR targeting `develop`
