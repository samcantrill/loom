...
- Phase execution plan path: `docs/roadmap/stage-10/phases/authority-mode-resolution.md`
...
- PR preparation draft:
  ...
  - PR facts confirmed: title
    ...
    PR body path `docs/roadmap/stage-10/phases/authority-mode-resolution-pr-body.md`; target
