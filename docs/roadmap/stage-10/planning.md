...
- Current discussion stage: Design-choice follow-up and implementation-plan
  refinement complete; `docs/roadmap/stage-10/implementation-plan.md`
...
- Resume with `.codex/workflows/roadmap-stage-planning.md` and this planning
...
1. Keep authority ownership names and boundaries explicit:
   ...
   Revisit trigger: a future roadmap stage introduces a real
...
3. Use strict import collision rejection in v10.
   ...
   revisit when a roadmap stage adds migration, repair, or archival import.
...
- Draft created at `docs/roadmap/stage-10/implementation-plan.md`.
