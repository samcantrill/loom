...
| --- | --- | --- | --- | --- |
| 1 | [#222](https://github.com/samcantrill/loom/pull/222) open; merge pending CI | Implementation and manager review complete; 45 targeted tests, Ruff, and Pyright pass; isolated CI required for the documented local contention limitation | Caller-supplied conformance cases remain intentionally bounded | Worktree and branch retained until remote merge |
