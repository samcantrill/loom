...
- Phase execution plan path: `docs/roadmap/stage-6/phases/slurm-cli-preflight.md`
- PR body path: `docs/roadmap/stage-6/phases/slurm-cli-preflight-pr-body.md`
...
- Wrote `docs/roadmap/stage-6/phases/slurm-cli-preflight-pr-body.md` with a concise
