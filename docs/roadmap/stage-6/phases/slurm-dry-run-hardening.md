...
- Phase execution plan path: `docs/roadmap/stage-6/phases/slurm-dry-run-hardening.md`
- PR body path: `docs/roadmap/stage-6/phases/slurm-dry-run-hardening-pr-body.md`
...
- Files and areas to inspect: `tests/e2e/test_cli_slurm_dry_run.py`,
  ...
  `docs/roadmap/stage-6/implementation-plan.md`, and the PR body.
...
- PR preparation: PR body drafted in
  `docs/roadmap/stage-6/phases/slurm-dry-run-hardening-pr-body.md` using final
