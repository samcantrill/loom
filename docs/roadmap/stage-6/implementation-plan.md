...
- Related planning notes:
  `docs/roadmap/stage-6/planning.md`
- Related source docs:
  - `docs/roadmap.md`
...
- Phase execution plan:
  `docs/roadmap/stage-6/phases/slurm-continuation-commands.md`.
...
- Phase execution plan:
  `docs/roadmap/stage-6/phases/slurm-dry-run-models.md`.
...
- Phase execution plan:
  `docs/roadmap/stage-6/phases/slurm-dry-run-scripts.md`.
...
- Phase execution plan:
  `docs/roadmap/stage-6/phases/slurm-cli-preflight.md`.
...
- Phase execution plan:
  `docs/roadmap/stage-6/phases/slurm-dry-run-hardening.md`.
