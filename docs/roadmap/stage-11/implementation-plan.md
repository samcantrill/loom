...
- Planning-readiness dependencies:
  - `docs/roadmap/stage-11/planning.md` records readiness
    `pass`
...
- Phase execution plan: `docs/roadmap/stage-11/phases/queue-service-python-surface.md`.
- PR body: `docs/roadmap/stage-11/phases/queue-service-python-surface-pr-body.md`.
...
- Phase execution plan:
  `docs/roadmap/stage-11/phases/managed-pools-local-launcher.md`.
- PR body: `docs/roadmap/stage-11/phases/managed-pools-local-launcher-pr-body.md`.
...
- Phase execution plan:
  `docs/roadmap/stage-11/phases/queue-ops-cli-docs-hardening.md`.
- PR body: `docs/roadmap/stage-11/phases/queue-ops-cli-docs-hardening-pr-body.md`.
