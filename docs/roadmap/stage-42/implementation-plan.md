...
| P5 | [dependency-lineage](phases/dependency-lineage.md) | in_progress | `agent/stage-42-p5-dependency-lineage` | none | Persist exact per-attempt input origins and query generic dependency graphs | Historical import evidence policy approved; implementation/full gate pending |
