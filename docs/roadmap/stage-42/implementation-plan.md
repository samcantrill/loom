...
| P5 | [dependency-lineage](phases/dependency-lineage.md) | blocked | `agent/stage-42-p5-dependency-lineage` | none | Persist exact per-attempt input origins and query generic dependency graphs | Imported source-identity policy requires maintainer decision; no product edits yet |
...
- Phase statuses: P1–P4 merged; P5 blocked at its explicit imported-identity
  refinement condition; P6 pending. P3 reconciled validation and
