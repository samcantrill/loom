...
implementation authorized; P1 merged, P2 in progress.
Roadmap stage: 42
...
Current phase: P2, run annotations; predecessor metadata publication and synchronization passed.
...
- Phase statuses: P1 merged; P2 in_progress; P3–P6 pending. On 2026-09-25 the maintainer
