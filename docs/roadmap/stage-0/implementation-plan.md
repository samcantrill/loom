...
Every phase execution plan in `docs/roadmap/stage-<id>/phases/` must include:
...
- PR body prepared at
  `docs/roadmap/stage-0/phases/add-primitives-serialization-pr-body.md`.
...
- Implementation refinement budget: used. PR review budget: consumed by manager
  ...
  recorded.
- PR body prepared at `docs/roadmap/stage-0/phases/add-io-basics-pr-body.md`.
- Historical PR creation blocker: branch push failed because SSH
  ...
  docs/roadmap/stage-0/phases/add-io-basics-pr-body.md` attempt then failed because the head
...
- PR body prepared at
  `docs/roadmap/stage-0/phases/add-recipes-instantiation-pr-body.md`.
...
- PR body prepared at
  `docs/roadmap/stage-0/phases/add-pipeline-specs-graph-pr-body.md` and finalized in commit
  `ba65fa6`.
...
- PR body prepared at
  `docs/roadmap/stage-0/phases/add-local-stores-run-layout-pr-body.md` in the phase branch.
...
- PR body prepared at
  `docs/roadmap/stage-0/phases/add-planning-resume-selectors-pr-body.md` in the phase branch.
...
- PR body prepared at `docs/roadmap/stage-0/phases/add-local-execution-pr-body.md` in the
...
- PR body prepared at `docs/roadmap/stage-0/phases/harden-v0-docs-pr-body.md` in the phase
