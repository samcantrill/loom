...
- Phase execution plan: `docs/roadmap/stage-0/phases/add-local-stores-run-layout.md`
- Draft pass: complete
...
```sh
gh pr create --base develop --head codex/add-local-stores-run-layout --body-file docs/roadmap/stage-0/phases/add-local-stores-run-layout-pr-body.md --title "Phase 7: Local Stores And Run Layout"
```
