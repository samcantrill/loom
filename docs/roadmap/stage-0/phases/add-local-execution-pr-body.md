...
- Phase execution plan: `docs/roadmap/stage-0/phases/add-local-execution.md`
...
`docs/roadmap/stage-0/phases/add-local-execution.md`, including focused Phase 9 slices,
...
```sh
gh pr create --base codex/add-planning-resume-selectors --head codex/add-local-execution --body-file docs/roadmap/stage-0/phases/add-local-execution-pr-body.md --title "Phase 9: Local Execution"
```
...
docs/roadmap/stage-0/phases/add-local-execution-pr-body.md` hit GitHub CLI's known Projects
...
body=@docs/roadmap/stage-0/phases/add-local-execution-pr-body.md`.
