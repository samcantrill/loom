...
- Expanded plan path: `docs/roadmap/stage-0/phases/add-recipes-instantiation.md`.
...
From `docs/roadmap/stage-0/implementation-plan.md`, Phase 5 is
...
- Source references:
  - `docs/roadmap/stage-0/implementation-plan.md`, especially Phase 5,
