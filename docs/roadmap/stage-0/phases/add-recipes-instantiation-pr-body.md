...
- Expanded phase plan: `docs/roadmap/stage-0/phases/add-recipes-instantiation.md`
...
```text
command: gh pr create --base develop --head codex/add-recipes-instantiation --title "Phase 5: Recipes And Instantiation" --body-file docs/roadmap/stage-0/phases/add-recipes-instantiation-pr-body.md
