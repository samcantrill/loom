...
- Expanded phase plan: `docs/roadmap/stage-0/phases/add-io-basics.md`
...
```text
command: gh pr create --base develop --head codex/add-io-basics --title "Phase 3: I/O Basics" --body-file docs/roadmap/stage-0/phases/add-io-basics-pr-body.md
