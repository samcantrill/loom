...
- Expanded plan path: `docs/roadmap/stage-0/phases/add-io-basics.md`.
...
From `docs/roadmap/stage-0/implementation-plan.md`, Phase 3 is `Status: pending` with branch `codex/add-io-basics` and PR `pending`.
