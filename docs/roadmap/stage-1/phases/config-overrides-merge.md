...
- Phase execution plan path: `docs/roadmap/stage-1/phases/config-overrides-merge.md`
- PR body path: `docs/roadmap/stage-1/phases/config-overrides-merge-pr-body.md`
...
- PR body path: `docs/roadmap/stage-1/phases/config-overrides-merge-pr-body.md`
- Final diff scope inspected against `develop`: `docs/roadmap/stage-1/phases/config-overrides-merge.md`,
  `docs/roadmap/stage-1/phases/config-overrides-merge-pr-body.md`, `src/loom/config/merge.py`,
