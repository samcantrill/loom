...
- Phase execution plan path: `docs/roadmap/stage-1/phases/config-instantiation-strict.md`
...
- PR preparation:
  ...
  - PR body artifact created at `docs/roadmap/stage-1/phases/config-instantiation-strict-pr-body.md`.
