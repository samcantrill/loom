...
- Phase execution plan path: `docs/roadmap/stage-1/phases/config-validation-boundaries.md`
...
- PR facts:
  ...
  - PR body artifact: `docs/roadmap/stage-1/phases/config-validation-boundaries-pr-body.md`.
...
- GitHub/auth notes:
  ...
  - After the PR body artifact changed from "PR not opened yet" to "PR
    ...
    body=@docs/roadmap/stage-1/phases/config-validation-boundaries-pr-body.md`.
- Stack maintenance:
