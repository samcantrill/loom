...
- Phase execution plan path: `docs/roadmap/stage-1/phases/config-manifest-provenance.md`
...
- PR preparation:
  - Expanded-path draft PR body completed at `docs/roadmap/stage-1/phases/config-manifest-provenance-pr-body.md`.
...
- Expanded-path PR body refine/open pass, 2026-05-06:
  ...
  - Refined `docs/roadmap/stage-1/phases/config-manifest-provenance-pr-body.md` to keep workflow details in phase notes and make the GitHub checks row accurate for PR submission.
