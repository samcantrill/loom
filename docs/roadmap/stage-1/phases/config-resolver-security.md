...
- Phase execution plan path: `docs/roadmap/stage-1/phases/config-resolver-security.md`
...
- PR preparation:
  ...
  - PR body artifact: `docs/roadmap/stage-1/phases/config-resolver-security-pr-body.md`.
