...
- Previous version status: v0-post hardening is recorded as merged in
  `docs/roadmap/stage-0-post/implementation-plan.md`.
- Planning notes status: handed off to `docs/roadmap/stage-1/implementation-plan.md`
...
- Related implementation plans:
  - `docs/roadmap/stage-0-post/implementation-plan.md`
  - `docs/roadmap/stage-1/implementation-plan.md`
  - `docs/roadmap/stage-2/implementation-plan.md`
...
- Blockers:
  ...
  - `docs/roadmap/stage-1/implementation-plan.md` passed the plan
...
- The current `docs/roadmap/stage-1/implementation-plan.md` must be refined because it still
  includes `_copy_`.
...
This is the current working order to refine in `docs/roadmap/stage-1/implementation-plan.md`.
...
- change-needed: refine `docs/roadmap/stage-1/implementation-plan.md`, feature docs, or phase
...
- Each phase should record accepted debt and future compatibility notes in its
  ...
  incomplete.
- `docs/roadmap/stage-1/implementation-plan.md` should remove `_copy_` implementation scope and
...
- Existing target plan: `docs/roadmap/stage-1/implementation-plan.md`.
- Roadmap entry: `docs/roadmap.md#v1---rebuildable-config-composition`.
...
- The existing `docs/roadmap/stage-1/implementation-plan.md` must remove `_copy_` scope and tests
