...
- PR preparation: `make validate-pr` passed; `make test-summary` passed with package `97 passed, 1 skipped`, unit `1182 passed, 7 skipped, 1 deselected`, contract `235 passed, 2 skipped`, integration `156 passed, 8 skipped, 13 deselected`, e2e `43 passed, 2 deselected`, and config-extra `440 passed, 1722 deselected`.
