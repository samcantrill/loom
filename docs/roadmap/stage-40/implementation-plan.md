...
Current phase: 4 - mcp-skills (pr_open; independent review pending)
Next phase: final closeout after Phase 4 delivery and synchronization
Blockers: none
...
| 4 | mcp-skills | pr_open | [MCP and portable skills](phases/mcp-skills.md) | agent/stage-40-p4-mcp-skills | [#304](https://github.com/samcantrill/loom/pull/304) | Optional SDK adapter, tool contracts, skill distribution, examples and SDK lane | Use both native source modes from Codex across projects |
...
| 4 | [#304](https://github.com/samcantrill/loom/pull/304), open | Optional MCP, thirteen tools, four portable skills and isolated SDK lane implemented. Both required gates passed at `b675257aa20f4e0b16f3fe12f887fbe6a03ea3bd`; 3,535 summary tests passed. Six relocated skill trials passed. Independent PR review is next | Live Codex and physical NAS not qualified; code-phase completion may retain this explicit release limitation | Retained Stage 40 worktree and phase branch; no unrelated checkout repurposed |
