...
- Worktree root and path: former path
  `/home/can134/work/active/loom-worktrees/stage-29-p15-management-cli-examples`
  (removed after merge)
...
- PR and merge: [#266](https://github.com/samcantrill/loom/pull/266) correctly
  targeted `develop`, was non-draft and mergeable, and passed final manager
  review at source/test head `71b25a0`; the approval-only head `98a9a6b` was
  squash-merged as `9b8f71d`
