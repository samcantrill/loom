...
- Phase execution plan path: `docs/roadmap/stage-7/phases/slurm-job-cancellation.md`
...
- Plan quality gate: passed in `docs/roadmap/stage-7/implementation-plan.md`
...
- PR preparation: PR body drafted in
  `docs/roadmap/stage-7/phases/slurm-job-cancellation-pr-body.md`; ready to open against
  `develop`
