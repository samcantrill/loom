...
- Related planning notes:
  `docs/roadmap/stage-7/planning.md`
- Plan review report:
  `docs/roadmap/stage-7/plan-review-report.md`
- Refinement summary:
  `docs/roadmap/stage-7/plan-refinement-summary.md`
- Confirmation review report:
  `docs/roadmap/stage-7/plan-confirmation-review-report.md`
- Related source docs:
  - `docs/roadmap.md`
...
- Phase execution plan and PR body are recorded in
  `docs/roadmap/stage-7/phases/slurm-submitted-lifecycle.md` and
  `docs/roadmap/stage-7/phases/slurm-submitted-lifecycle-pr-body.md`.
...
- Phase execution plan and PR body are recorded in
  `docs/roadmap/stage-7/phases/slurm-live-command-models.md` and
  `docs/roadmap/stage-7/phases/slurm-live-command-models-pr-body.md`.
...
- Phase execution plan and PR body are recorded in
  `docs/roadmap/stage-7/phases/slurm-scheduler-status.md` and
  `docs/roadmap/stage-7/phases/slurm-scheduler-status-pr-body.md`.
...
- Phase execution plan and PR body are recorded in
  `docs/roadmap/stage-7/phases/slurm-job-cancellation.md` and
  `docs/roadmap/stage-7/phases/slurm-job-cancellation-pr-body.md`.
...
- Phase execution plan and PR body are recorded in
  `docs/roadmap/stage-7/phases/slurm-acceptance-hardening.md` and
  `docs/roadmap/stage-7/phases/slurm-acceptance-hardening-pr-body.md`.
