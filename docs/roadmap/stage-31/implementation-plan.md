...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | discord-webhook-event-sink | in_progress | docs/roadmap/stage-31/phases/discord-webhook-event-sink.md | agent/stage-31-p1-discord-webhook-event-sink | pending | downstream example package, extension catalog/docs, focused tests | Deliver copyable remote Discord reporting without changing Loom core. |
