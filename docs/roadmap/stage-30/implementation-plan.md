...
| 3 | [#229](https://github.com/samcantrill/loom/pull/229) squash-merged as `4437a51` | Implementation, manager validation, and GitHub CI passed | Fake backend is local-only; config changes remain fail-closed after authority commits | Phase branch and worktree removed after merge |
