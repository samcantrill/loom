...
```sh
gh pr create --base develop --head codex/v0-post-core-contracts --title "Phase 1: Core contracts, schemas, and packaging" --body-file docs/roadmap/stage-0-post/phases/v0-post-core-contracts-pr-body.md
```
