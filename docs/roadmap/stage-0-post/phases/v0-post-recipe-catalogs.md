...
- Phase execution plan path: `docs/roadmap/stage-0-post/phases/v0-post-recipe-catalogs.md`
...
- PR body path: `docs/roadmap/stage-0-post/phases/v0-post-recipe-catalogs-pr-body.md`.
- PR body draft pass: complete in
  `docs/roadmap/stage-0-post/phases/v0-post-recipe-catalogs-pr-body.md`.
