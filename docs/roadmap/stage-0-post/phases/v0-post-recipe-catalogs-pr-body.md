...
- Phase execution plan: `docs/roadmap/stage-0-post/phases/v0-post-recipe-catalogs.md`
...
`docs/roadmap/stage-0-post/phases/v0-post-recipe-catalogs.md`.
...
```sh
gh pr create --base develop --head codex/v0-post-recipe-catalogs --title "Phase 6: Explicit Recipe Catalogs and Fresh Composition" --body-file docs/roadmap/stage-0-post/phases/v0-post-recipe-catalogs-pr-body.md
```
