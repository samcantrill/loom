...
- Phase execution plan: `docs/roadmap/stage-0-post/phases/v0-post-store-capabilities.md`
...
Focused implementation and refinement evidence is recorded in `docs/roadmap/stage-0-post/phases/v0-post-store-capabilities.md`.
...
```sh
gh pr create --base develop --head codex/v0-post-store-capabilities --title "Phase 2: Store, Artifact, and Stage Context Capabilities" --body-file docs/roadmap/stage-0-post/phases/v0-post-store-capabilities-pr-body.md
```
