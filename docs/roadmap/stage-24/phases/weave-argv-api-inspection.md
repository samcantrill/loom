...
- PR preparation: in progress; PR body drafted at `docs/roadmap/stage-24/phases/weave-argv-api-inspection-pr-body.md`
...
- PR facts: pending GitHub creation; expected base `develop`, head `codex/weave-argv-api-inspection`, title `Weave Argv Config Shorthand - Phase 3: Public Argv API and Inspection`
