...
- Phase execution plan path: `docs/roadmap/stage-4/phases/executor-capabilities.md`
- PR body draft path: `docs/roadmap/stage-4/phases/executor-capabilities-pr-body.md`
...
- PR preparation: draft-only pass completed on 2026-05-07 by
  ...
  `docs/roadmap/stage-4/phases/executor-capabilities-pr-body.md`, refreshed
