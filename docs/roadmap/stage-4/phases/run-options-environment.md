...
- Phase execution plan path: `docs/roadmap/stage-4/phases/run-options-environment.md`
- Full plan: `docs/roadmap/stage-4/implementation-plan.md`
- PR body draft path: `docs/roadmap/stage-4/phases/run-options-environment-pr-body.md`
...
- PR preparation draft: completed on 2026-05-07. Read `AGENTS.md`, the v4
  ...
  `docs/roadmap/stage-4/phases/run-options-environment-pr-body.md` for
