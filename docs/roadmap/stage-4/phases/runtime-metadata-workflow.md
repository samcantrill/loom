...
- Phase execution plan path: `docs/roadmap/stage-4/phases/runtime-metadata-workflow.md`
- PR body draft path: `docs/roadmap/stage-4/phases/runtime-metadata-workflow-pr-body.md`
