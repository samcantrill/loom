...
- Related implementation plans:
  - `docs/roadmap/stage-3/implementation-plan.md`
...
- Checkpoint status: complete; reset or compact context before design decision
  review.
- Notes path: `docs/roadmap/stage-4/planning.md`
- Resume instruction: reread this planning notes file and
  `.codex/prompts/roadmap-stage-planning-facilitate.md`, then reload
  `docs/roadmap.md`,
...
- Source roadmap: `docs/roadmap.md`, v4
  section.
