...
- Source roadmap:
  `docs/roadmap.md`
- Previous version status: complete. `docs/roadmap/stage-9/implementation-plan.md` records v9 as
...
- Stage gates:
  ...
  - Phase shaping: complete; ten-phase plan after post-draft HPC deployment
    refinement
  - Handoff: complete; `docs/roadmap/stage-9-post/implementation-plan.md` drafted and refined
...
| Handoff | Planning notes were used as source material for `docs/roadmap/stage-9-post/implementation-plan.md`. | Do not start implementation from this workflow. | Complete; implementation plan refined for HPC deployment/fallback concerns. | Plan quality gate. |
...
- Checkpoint status: prepared but not formally compacted/reset in the current
  session
- Notes path: `docs/roadmap/stage-9-post/planning.md`
- Resume instruction: Reload this planning notes file, the v9 implementation
  plan, and `.codex/prompts/roadmap-stage-planning-facilitate.md`,
...
sequence is in `docs/roadmap/stage-9-post/implementation-plan.md`.
