...
- Adds `docs/roadmap/stage-9-post/implementation-plan.md` and the
  confirmed v9-post planning notes because the source plan commit is present
  locally but not yet on `origin/develop`.
- Adds `docs/roadmap/stage-9-post/phases/authority-inventory-contracts.md` as the durable Phase 1
