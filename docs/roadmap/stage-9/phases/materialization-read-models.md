...
- Phase execution plan path: `docs/roadmap/stage-9/phases/materialization-read-models.md`
...
- PR body draft pass: complete on 2026-05-10 by `loom_pr_preparer`; draft
  written to `docs/roadmap/stage-9/phases/materialization-read-models-pr-body.md` from the
...
- PR facts and target readiness: title remains `Persistence And Concurrency
  ...
  `docs/roadmap/stage-9/phases/materialization-read-models-pr-body.md`; local merge base with
