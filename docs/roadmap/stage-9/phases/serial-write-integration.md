...
- Phase execution plan path: `docs/roadmap/stage-9/phases/serial-write-integration.md`
- PR body path: `docs/roadmap/stage-9/phases/serial-write-integration-pr-body.md`
...
- PR body draft pass: complete on 2026-05-10; public PR body written to
  `docs/roadmap/stage-9/phases/serial-write-integration-pr-body.md`.
