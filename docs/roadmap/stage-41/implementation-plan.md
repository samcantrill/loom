...
Blockers: Phase 7 independent review found retained-unaccepted observation abort; additional scoped correction authorization required (3/3 corrections used)
...
| 7 | unified-sweeps | blocked | [Phase 7](phases/unified-sweeps.md) | agent/stage-41-p7-unified-sweeps | [317](https://github.com/samcantrill/loom/pull/317) | Sweep expansion/dispatch state and native admission references | Sweep trials use the unified run lifecycle with unchanged experiment meaning and stable retry identities. |
...
| 7 | [317](https://github.com/samcantrill/loom/pull/317), open | Both fresh gates passed; independent review found retained-unaccepted observation abort; proposed fourth correction requires authorization | Observation blocker recorded in Phase 7 card; physical qualification remains explicit | Evidence archived; current PR remains unmerged; successor start blocked |
