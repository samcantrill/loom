...
| 7 | pending | Prepared on published `2e3050b`; implementation in progress | Sweep semantic/replay evidence and shared-owner disposition pending | Pending consumer conversion/removal audit |
