...
| 3 | pending | Prepared on published `4e3635b`; implementation in progress | Live fleet qualification and mixed-role process evidence pending | Pending this phase's ordinary-run removal audit |
