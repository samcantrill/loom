...
| 4 | [311](https://github.com/samcantrill/loom/pull/311), open | Implemented; review correction and both fresh required gates passed on `1196926`; same-reviewer confirmation and delivery pending | Native/fake Docker/Apptainer journeys and recovery validated; physical qualification unavailable and unclaimed | Assigned examples converted; obsolete workload fixtures removed; evidence archived; no phase-owned processes remain |
