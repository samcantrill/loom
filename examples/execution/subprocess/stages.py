"""Example stage implementations for local and subprocess execution."""
...
class FailingNumbersStage:
    def run(
        ...
        _ = context, inputs
        print("subprocess example is failing intentionally", file=sys.stderr)
        raise RuntimeError("subprocess example failed intentionally")
