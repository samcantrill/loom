...
7. Update `docs/implementation-plan.md` phase status to `pr_open` without overwriting unrelated content.
8. Ensure the expanded phase plan has completion notes.
9. Create a PR body using `.github/PULL_REQUEST_TEMPLATE.md`.
10. Open the PR if GitHub tooling and authentication are available. Otherwise, leave the PR body ready to use and document why the PR was not opened.
