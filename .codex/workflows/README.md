...
| --- | --- | --- |
| `roadmap-version-planning.md` | The user wants an interactive design discussion for one roadmap version, then an implementation-plan draft after final confirmation | `roadmap-version-planning-notes-facilitate.md`, then `implementation-plan-draft.md` |
